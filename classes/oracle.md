...
- **雷（Lightning）ビルド**: [オラクル・ライトニングメイジビルド](../builds/oracle-lightning.md)
- **召喚（Summoner）ビルド**: [オラクル・サモナービルド](../builds/oracle-summoner.md)（⚠️ Bonus Summonsモディファイアのバグ注意）
...
- **Summoner Strategist（召喚戦略家）**: 召喚物の強化・運用に関するタレント（推定）。詳細効果は情報収集中。このタレントを軸にした[サモナービルド](../builds/oracle-summoner.md)が存在する
...
- **Enhanced Vision モディファイア** と **Spiritual Aura（Oracleパッシブ）** が正しく相互作用しない不具合を修正
